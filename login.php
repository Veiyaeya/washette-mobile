...
if (isset($_SESSION['CustomerID'])) {
  ...
  // If logged in, redirect to userHome page
  ...
  if(isset($_POST['login'])) {
    ...
    if ($user) {
      ...
      Swal.fire({
        ...
        window.location.href = '/washette/washette/userFolder/userHome.php';
      });
    ...
    <div class="glass-card text-center">
      ...
      <form method="POST" action="">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <a href="fpassword.html" class="link-btn">Forgot password?</a>
        </div>
        ...
        <div class="mt-3">
          <p>Are you an admin? <a href="../washette/loginAdmin.php" class="link-btn" style="text-decoration: underline; font-weight: bold;" >Login as Admin</a></p>
        </div>
